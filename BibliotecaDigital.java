...
public static void main(String[] args) {
    ...
    do {
        ...
        String inputOpcao = scan.nextLine();
        ...
        switch (opcao) {
            ...
            case 5:
                ...
                String inputMat = scan.nextLine();
                try {
                    int mat = Integer.parseInt(inputMat);
